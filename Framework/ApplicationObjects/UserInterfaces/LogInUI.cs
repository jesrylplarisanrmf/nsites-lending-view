    ...
    public partial class LogInUI : Form
    {
        ...
        private void LogInUI_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                #region "Get CORE Base Address"
                string filenameCORE = "";
                if (GlobalVariables.CurrentConnection == "Production Server")
                {
                    filenameCORE = @"BaseAddressCORE-ProductionServer.txt";
                }
                else if (GlobalVariables.CurrentConnection == "Test Server")
                {
                    filenameCORE = @"BaseAddressCORE-TestServer.txt";
                }
                else if (GlobalVariables.CurrentConnection == "Development Server")
                {
                    filenameCORE = @"BaseAddressCORE-DevelopmentServer.txt";
                }
                else
                {
                    filenameCORE = @"BaseAddressCORE-DevelopmentServer.txt";
                }
                string lineCORE = null;
                TextReader readFileCORE = new StreamReader(filenameCORE);
                lineCORE = readFileCORE.ReadLine();
                readFileCORE.Close();
                readFileCORE = null;
                GlobalVariables.BaseAddressCORE = lineCORE;
                #endregion
